---
title: "Mapa de infraestructura verde en Montes de Oca"
output: 
...
### Datos para descarga: [Capa de infraestructura verde en Montes de Oca](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/montesdeoca/IV_MONTES_DE_OCA.TIF)
```{r}

leaflet() %>%
  setView(-83.99, 9.935, 13) %>%
